...
abstract class Model implements Arrayable, ArrayAccess, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable
{
     ...
     * @throws \Exception
     */
    public function removeRecorder($property = "name")
    {
        if ($delete = $this->delete()) {
            $text = trans("home.alert_success_delete", ['name' => $this->$property]);
            return jsonSuccess($text, $delete);
        }
        else{
            $text = trans("home.alert_error_delete", ['name' => $this->$property]);

            return jsonError($text, $delete);
        }
    }
    ...
    {
        return jsonSuccess( trans("home.alert_success_update") , $this->update( $data ) );
    }
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function createRecord($data = [], $property = null)
    {
        return jsonSuccess( trans("home.alert_success_create", ['name' => $property ] ) , $this->create( $data ) );
    }
