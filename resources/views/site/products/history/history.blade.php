    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <table id="ma-admin-datatable" class="table table-bordered table-striped" data-url="{{ route('product.history') }}">
                        <thead>
                        <tr>
                            <th>#</th>
                            ...
                            <th>{{ trans("products_history.quantity_consumed") }}</th>
                            <th>{{ trans("products_history.consumption") }}</th>
...
{{--        <script src="{{ admin_assets("/js/datatables/table.js") }}"></script>--}}
        <script>
