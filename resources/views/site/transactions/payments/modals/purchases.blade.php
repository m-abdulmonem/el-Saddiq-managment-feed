            ...
            <form method="post" id="paymentsForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="row bill-info" style="display: none">
                        <div class="col-6">
                            <ul class="list-unstyled main-info">
                                <li>@lang("suppliers/bills.code") : <span id="billCode"></span></li>
                                <li>@lang("balances.remaining") : <span id="remainingBalance"></span></li>
                            </ul>
                        </div>
                        <div class="col-6">
                            <ul class="list-unstyled main-info">
                                <li>@lang("suppliers/suppliers.name"): <span id="supplier"></span></li>
                    ...
                    <div class="form-group ">
                        ...
                        <select name="bill_id" id="bill" class="form-control"></select>
                        <div class="alert alert-danger hide"></div>
                    </div>
    ...
    <script>
        ...
        $(function () {
            $("#bill").select2({
                ...
                ajax: {
                    url: '{{ route("ajax.suppliers.bills.names") }}',
                    dataType: 'json',
            ...
            function btnUpdate(el) {
                $(".modal-title").text("@lang("$trans.update") " + $(el).data("bill"));
            ...
            function update(el) {
                ajaxApi({
                    url: `/payment/purchases/${ $(el).find("#id").val() }`,
                    type: "PUT",
                    data: $(el).serialize(),
                    success: function (data) {
                        if (data.code === 1) {
