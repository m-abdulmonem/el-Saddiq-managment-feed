                ...
                <div class="modal-body">
                    ...
                    <div class="form-group ">
                        ...
                        <select name="payment" id="payment" class="form-control">
                            ...
                            <option value="cheque">@lang("transactions/payments.cheque")</option>
                        </select>
    ...
    <script>
        ...
        $(function () {
            ...
            $("#bill").select2({
                ...
                ajax: {
                    url: '{{ route("ajax.suppliers.returned.bills.codes") }}',
                    dataType: 'json',
            ...
            function create(el) {
                ajaxApi({
                    url: "{{ route("purchases.returned.store") }}",
                    type: "POST",
                    data: $(el).serialize(),
            ...
            function update(el) {
                ajaxApi({
                    url: `/receipts/returned/${ $(el).find("#id").val() }`,
                    type: "PUT",
                    data: $(el).serialize(),
                    success: function (data) {
                        if (data.code === 1) {
